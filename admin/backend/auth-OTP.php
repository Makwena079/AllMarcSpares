...
<?php 
    if(isset($_GET['email_address'])){
        ...
        header('Location: ./auth-recoverpw.php?email-missing=true here');
    } 
?>
<html lang="en">
                                    ...
                                    <div class="row">
                                       <div class="col-lg-12">
                                          <div class="floating-label form-group">
                                             <input class="floating-input form-control" name="otp_code" id="otp_code" type="text" placeholder=" ">
                                             <label>OTP</label>   
                                          </div>
                                       </div>
                                       </div>
                                       ...
                                       <div class="col-lg-12">
                                       <div class="floating-label form-group">
                                       <input class="floating-input form-control" name="email_address" id="email_address" type="email" value="<?= $email_address;?>" hidden>
                                       </div>
                                       </div>
                                    </div>
