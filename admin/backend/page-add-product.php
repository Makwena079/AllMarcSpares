        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="add-product.php" method="POST" data-toggle="validator">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Product Brand *</label>
                                        <select name="brand_name" id="brand_name" class="selectpicker form-control" data-style="py-0">
                                ...
                                <div class="col-md-6">                      
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="p_name" id="p_name" placeholder="Enter Prodect Name" data-errors="Please Enter product." required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="p_code" id="p_code" placeholder="Enter Product Code" data-errors="Please Enter Code." required>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div> 
                                <div class="col-md-6"> 
                                    <div class="form-group">
                                        ...
                                        <select name="c_type" id="c_type" class="selectpicker form-control" data-style="py-0">
                                        ...
                                        <?php
                                                    ...
                                                    if($result) { 
                                                       while($categorylist = mysqli_fetch_array($result)){
                                                        echo '<option value="'.$categorylist['c_name'].'">'.$categorylist['c_name'].' </option>'; 
                                                       }
                                                    }
                                                ?>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="p_price" id="p_price" value="R" placeholder="Enter Price" data-errors="Please Enter Price." required>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Image</label>
                                        <input type="file" name="p_picture" id="p_picture" class="form-control image-file" accept="image/*">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Product Description / Product Details</label>
                                        <textarea class="form-control" rows="4" name="p_description" id="p_description"></textarea>
                                    </div>
                                </div>
                            </div>                            
